...
<?php
echo CHtml::image(Yii::app()->baseUrl."/images/".$tweet["foto_perfil"],$tweet["foto_perfil"], array("style"=>"float:left;margin-left: 3px;margin-top: 3px; border-radius: 5px;","height"=>"48", "width"=>"48") ); ?>
